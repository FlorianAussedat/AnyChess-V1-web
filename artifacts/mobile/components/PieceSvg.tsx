/**
 * Chess pieces — CBurnett set (Lichess default, CC BY-SA 3.0, Colin M.L. Burnett).
 * Uses SvgXml to render the original SVG paths, so pieces look exactly
 * as they do on Lichess: recognisable Staunton silhouettes.
 */
